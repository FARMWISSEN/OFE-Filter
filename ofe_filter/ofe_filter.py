...
class OFEFilter:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('OFEFilter', message)
    ...
    def run(self):
        ...
        # Pfad zum neuen Ordner "OFE_Filter"
        self.ofe_filter_dir = os.path.join(project_dir, "OFE_Filter")

        # Überprüfen, ob der Ordner bereits existiert, und falls nicht, erstellen
        if not os.path.exists(self.ofe_filter_dir):
            os.makedirs(self.ofe_filter_dir)
       
        # Erstellen und Anzeigen des Dialogs
        if self.first_start:
            #self.first_start = False
            self.dlg = OFEFilterDialog(self.ofe_filter_dir, self)
    ...
    ### Daten laden ###
    ###################
    def add_filtered_layer(self, original_layer, ofe_filter_dir):
        ...
        new_layer_path = os.path.join(ofe_filter_dir, new_layer_name + ".shp")
    ...
    def cleanup_plugin_resources(self):
        ...
        if hasattr(self, 'ofe_filter_dir'):
            self.ofe_filter_dir = None