...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ofe_filter_dialog_base.ui'))


class OFEFilterDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, ofe_filter_dir, plugin_instance, parent=None):
        ...
        self.ofe_filter_dir = ofe_filter_dir  # Speichert den Pfad des Zielordners
    ...
    def on_ok_button_clicked(self):
        ...
        # Layer erzeugen
        self.plugin_instance.add_filtered_layer(daten_layer, self.ofe_filter_dir)

        # Aktualisiere die Buttons nach dem Datenladen
        self.update_button_states()

        # LogManager initialisieren
        self.log = log(self.mMapLayerComboBox_Daten.currentText(), self.ofe_filter_dir)
    ...
    def save_histogram(self):
        project_path = self.ofe_filter_dir
